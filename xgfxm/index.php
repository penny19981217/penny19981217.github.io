...
<style type="text/css">
        ...
        .cl6_yellow {
            height: 40px;
            background: url("cssjs/imgs/3_07_y.jpg") no-repeat;
            background-size: 100%;
        }
        ...
        .cl6_grey {
            height: 40px;
            background: url("cssjs/imgs/grey.png") no-repeat;
            background-size: 100%;
        }
...
<body>
    ...
    <div class="page-hd cl2">
        <p style="font-size: 30px; font-family: STHeiti; font-weight: bold;" align="center">郑祺</p>
    </div>
    <div class="page-hd cl3" style=" text-align: center;float:none;">
        <p style="font-size: 20px; text-align:center;">202130181064</p>
        <p style="font-size: 16px; text-align:center;">经济学院</p>
        <p style="font-size: 16px; text-align:center;">
        </p>
        <div id="qr" class="tcenter" style="padding: 10px;height:170px;">
                                <img width="110px" height="160px" src=./cssjs/tx/2022/ea3f0540a9f8aa5bccab1287bb4b50f8895b09be1f2d1475897db231621edd6c.jpg>
    ...
    <div class="page-hd cl5">
                ...
                <p style=" color:#fff;   font-size: 25px;  font-weight: 200;" align="center">未经请假离校</p>
            </div>
